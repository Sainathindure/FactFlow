...
train_news = pd.read_csv(r"D:\College\Minor 2\train.csv")
test_news = pd.read_csv(r"D:\College\Minor 2\test.csv")
valid_news = pd.read_csv(r"D:\College\Minor 2\valid.csv")
...
#process the data
def process_data(data, exclude_stopword=True, stem=True, eng_stemmer=None):
